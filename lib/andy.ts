...
- Spotify is ideal for music discovery and brand integration within the music industry. Facebook and X are generally less effective for brand partnerships due to lower engagement and organic reach, so they should be used strategically and only if they genuinely fit the creator's profile and audience, but Facebook is really good at reaching an older audience and X is good for easy reach and engagement with a broad audience, so they can be a good secondary platform for some creators. Pinterest is great for visual discovery and can be a strong platform for lifestyle, fashion, home decor, and DIY niches. Twitch is ideal for gaming, live streaming, and interactive content, making it a good fit for creators in those spaces.
...
- platform is the primary platform (single string), one of: Instagram, TikTok, YouTube, LinkedIn, Newsletter, Podcast
